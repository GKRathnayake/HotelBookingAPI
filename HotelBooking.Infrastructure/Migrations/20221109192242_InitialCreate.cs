        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowestRoomPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacilityHotel", x => new { x.FacilitiesFacilityId, x.HotelsHotelId });
                    table.ForeignKey(
                        name: "FK_FacilityHotel_Facilities_FacilitiesFacilityId",
                        column: x => x.FacilitiesFacilityId,
                        principalTable: "Facilities",
                        principalColumn: "FacilityId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FacilityHotel_Hotels_HotelsHotelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityHotel_HotelsHotelId",
                table: "FacilityHotel",
